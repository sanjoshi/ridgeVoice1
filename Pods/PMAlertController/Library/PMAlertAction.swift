...
@objc open class PMAlertAction: UIButton {
    ...
    @objc public convenience init(title: String?, style: PMAlertActionStyle, action: (() -> Void)? = nil){
        ...
        style == .default ? (self.setTitleColor(UIColor(red: 136.0/255.0, green: 78.0/255.0, blue: 160.0/255.0, alpha: 1.0), for: UIControl.State())) : (self.setTitleColor(UIColor.gray, for: UIControl.State()))
